  ...
  return (
    <div className={style.categories}>
      ...
      <ul className={style.links}>
        <Link className={style.a} to={'/store/shop'}>
          <li className={style.linksItem}>Special Offer!</li>
        </Link>
        <Link className={style.a} to={'/store/shop/necklaces'}>
          <li className={style.linksItem}>Necklaces</li>
        </Link>
        <Link className={style.a} to={'/store/shop/rings'}>
          <li className={style.linksItem}>Rings</li>
        </Link>
        <Link className={style.a} to={'/store/shop/bracelets'}>
          <li className={style.linksItem}>Bracelets</li>
        </Link>
        <Link className={style.a} to={'/store/shop/earrings'}>
          <li className={style.linksItem}>Earrings</li>
        </Link>
        <Link className={style.a} to={'/store/shop/charms'}>
